...
https://lesoto-trooper.github.io/Lesoto-trooper.io/
...
Todas las las imagenes, para evitar infringir copyright, han sido generadas con un modelo de IA de generación de imagenes, abierto y libre de de descarga, el modelo ha sido operado de forma local es decir no he usado ninguna empresa para poder generar y procesar las imagenes, todo ha sido en un ordenador de mi propiedad. 

Modelo usado: Z-image (version turbo) 
